...
# NotebookLM Chat System Prompt

Source: Google NotebookLM (multiple leaked versions)
...
📚 **Deeper dive:** See [notebooklm-deeper-dive.md](./notebooklm-deeper-dive.md) for all leaked prompt versions, custom goals/personas, performance upgrades, and security notes.
